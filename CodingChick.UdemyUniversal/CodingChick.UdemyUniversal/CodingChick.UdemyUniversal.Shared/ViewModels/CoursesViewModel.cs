...
{
    public class CoursesViewModel : ScreenWithAnalytics
    {
        ...
        public CoursesViewModel(INavigationService navigationService, IDataService iDataService, IAnalyticsService analyticsService)
